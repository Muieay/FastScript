...
curl --fail --show-error --location --progress-bar -o $TEMP_DIR/ollama "https://github.moeyy.xyz/$(release_url)/download/$(get_latest_release)/ollama-linux-${ARCH}${VER_PARAM}"
